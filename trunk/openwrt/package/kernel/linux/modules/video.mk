...
define KernelPackage/video-hdpvr
  TITLE:=Hauppauge HD PVR device support
  DEPENDS:=@USB_SUPPORT +kmod-usb-core
  KCONFIG:=CONFIG_VIDEO_HDPVR
  FILES:=$(LINUX_DIR)/drivers/media/$(V4L2_USB_DIR)/hdpvr/hdpvr.ko
  AUTOLOAD:=$(call AutoLoad,70,hdpvr)
  $(call AddDepends/video)
endef

define KernelPackage/video-hdpvr/description
 Kernel module for Hauppauge HD PVR device support
endef

$(eval $(call KernelPackage,video-hdpvr))
